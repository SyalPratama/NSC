      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-10">
        ...
        <div className="flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-end">
          ...
          <div className="flex flex-wrap items-center gap-6 text-[13px] font-bold text-white">
            ...
            <Link href="#" className="transition-colors hover:text-orange-500">Operator Satelit</Link>
            <Link href="/reseller" className="transition-colors hover:text-orange-500">Reseller Resmi</Link>
          </div>
