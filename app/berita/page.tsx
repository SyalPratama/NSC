    ...
    <main className="relative min-h-screen bg-black text-gray-200 selection:bg-orange-500/30 overflow-hidden font-sans">
      ...
      <div className="relative z-10 container mx-auto px-6 pt-32 pb-20 max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          <h1 className="text-4xl font-bold tracking-tight text-white">Berita <span className="text-orange-500">Terbaru</span></h1>
          <div className="relative w-full md:w-64">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500" size={16} />
            <input 
              type="text" 
              placeholder="Cari berita..." 
              className="w-full bg-white/5 border border-white/10 rounded-full py-2 pl-10 pr-4 text-sm outline-none focus:border-orange-500 focus:bg-white/10 transition-all text-white placeholder-gray-500"
            />
          </div>
        </div>
